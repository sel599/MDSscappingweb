...
Fungsi utama BEI:
-Menyediakan tempat perdagangan efek yang teratur, wajar, dan efisien.
-Memfasilitasi perusahaan untuk melakukan penawaran umum (IPO).
-Menyebarkan informasi pasar kepada publik dan pelaku pasar.
-BEI berada di bawah pengawasan Otoritas Jasa Keuangan (OJK) dan merupakan hasil penggabungan Bursa Efek Jakarta (BEJ) dan Bursa Efek Surabaya (BES) pada tahun 2007.
...
1. Mengambil kode perusahaan tercatat apabila ada Perusahaan IPO baru yang melantai di Bursa Eefek Indonesia.
   ...
   Data :
   disimpan dalam .csv
   # Export Raw Format Dataframe to CSV dengan nama : ListPerusahaanIDX-22052025.csv
...
2. Dari list poin 1, dilakukan scraping kembali untuk mengambil detail lengkap tentang profil informasi perusahaan seperti nama direksi, alamat hingga corporate secretary.
   ...
   Data :
   disimpan dalam .csv
   # Export Raw Format Dataframe to CSV dengan nama : BEI_Other_Data_Final-22052025.csv
    df_Final.to_csv(r'result\BEI_Other_Data_Final-22052025.csv', index=None, sep='|')
   
Data Final yang digunakan :
